...
Минимальный пакет для воспроизводимого тестирования научного руководителя.
Содержит только модули системы, сценарии экспериментов, требования и подробную документацию.
